# Preparazione lista esercizi da aggiungere
listaEsercizi = []
quantiEsercizi = int(input("Inserisci il numero di esercizi: ")) + 1
for n in range(1, quantiEsercizi):
    esercizioDaAggiungere = input("Inserisci il numero dell'esercizio da aggiungere\nPari o dispari (1)\nUtilizzo while(2)\nUtilizzo range(3)\nUtilizzo for(4)\nEsercizio misto(5): ")
    listaEsercizi.append(esercizioDaAggiungere)
    
for n in listaEsercizi:
    match n:
        case "1":
        ...
        case "5":
            ...
            while n <= len(lista2):
                n += 1
            print(f"{n} è la lunghezza massima")